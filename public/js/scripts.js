...
function setResponse(response){
    let qrSvg = document.getElementById('qrSvg'),
        ...
        if(typeof response.url !== 'undefined' && response.url !== '') rec.innerHTML ='<div class="alert alert-info m-0 mt-2"><i class="fas fa-link"></i>&nbsp;<a href="' + response.url +  '" >' + response.url + '</a></div>'
